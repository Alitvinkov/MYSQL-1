...
-- alter table users modify column updated_at current_timestamp;
--  
-- insert users set updated_at = now where updated_at = null;
-- update into users (updated_at) values now();
